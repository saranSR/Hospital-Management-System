                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6">
                        <div class="text-center text-white">
                            <!-- Page heading-->
                            <h1 class="mb-5">Hospital Management System</h1>
                            <!-- Signup form-->
                            <!-- * * * * * * * * * * * * * * *-->
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                            ...
                            <h5>Margaret E.</h5>
                            <p class="font-weight-light mb-0">"This is fantastic! Easy to use!"</p>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                            ...
                            <h5>Fred S.</h5>
                            <p class="font-weight-light mb-0">"HMS helps to manage patient details easily."</p>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="testimonial-item mx-auto mb-5 mb-lg-0">
